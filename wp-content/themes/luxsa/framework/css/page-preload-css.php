...
<?php
$page_loading_bgcolor = luxsa_get_option('page_loading_bgcolor', '#fff');
$page_loading_textcolor = luxsa_get_option('page_loading_textcolor', '#181818');
?>
.la-image-loading{
...
<?php if( luxsa_get_option('catalog_mode', 'off') == 'on' && luxsa_get_option('catalog_mode_price', 'off') == 'on' ){ ?>
