...
class Manager extends Module {
	...
	private function init_breakpoints() {
		...
		foreach ( $default_config as $breakpoint_name => $breakpoint_config ) {
			...
			if ( self::BREAKPOINT_KEY_MOBILE === $breakpoint_name || self::BREAKPOINT_KEY_TABLET === $breakpoint_name || self::BREAKPOINT_KEY_LAPTOP === $breakpoint_name || self::BREAKPOINT_KEY_TABLET_PORTRAIT === $breakpoint_name ) {
