...
function lahb_styling_tab_output( $atts = array(), $el = '', $class = '', $class_hover = '' ) {
    ...
    if ( ! empty( $background_image_all ) ) :
        ...
        $desktop_style .= ! empty( $background_position_all ) ? 'background-position:' . $background_position_all . ';' : 'center center;' ;
        $desktop_style .= ! empty( $background_repeat_all ) ? 'background-repeat:' . $background_repeat_all . ';' : 'no-repeat;' ;
