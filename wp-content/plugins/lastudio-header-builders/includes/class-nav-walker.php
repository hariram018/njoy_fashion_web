...
if ( ! class_exists( 'LAHB_Nav_Walker' ) ) :
    ...
    class LAHB_Nav_Walker extends Walker_Nav_Menu{
        ...
        public static function is_new_nav(){
        	return function_exists('lastudio_get_theme_support') && lastudio_get_theme_support('header-builder::menu');
        }

        public static function is_support_elementor(){
            return post_type_supports('nav_menu_item', 'elementor');
        }
        ...
        public function start_lvl( &$output, $depth = 0, $args = array() ) {
            ...
            if( $depth == 0 && $this->is_megamenu ) {
                ...
                if(!self::is_support_elementor()){
                    $output .= '<ul class="mm-mega-ul">';
                }
                else{
        ...
        public function display_element( $element, &$children_elements, $max_depth, $depth, $args, &$output ) {
	        ...
	        if(isset($args[0]->show_megamenu) && $args[0]->show_megamenu == 'true' && isset($element->menu_type) && $element->menu_type == 'wide' && self::is_support_elementor()) {
		        $ignore_child = true;
