<?php
if(!function_exists('lahb_button')) {
    function lahb_button($atts, $uniqid, $once_run_flag = true) {
        ...
        $com_uniqid = ' [Button ' . filter_var($uniqid, FILTER_SANITIZE_NUMBER_INT) .']';
